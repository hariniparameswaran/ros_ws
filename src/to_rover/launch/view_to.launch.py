...
def generate_launch_description():
    ...
    pkg_path = get_package_share_directory('to_rover')
    urdf_file = os.path.join(pkg_path, 'urdf', 'to_rover.urdf.xacro')
    control_yaml=os.path.join(get_package_share_directory('to_rover'),'config',
    'to_control_manager.yaml')      
